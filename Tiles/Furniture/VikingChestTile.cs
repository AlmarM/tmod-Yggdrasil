...
namespace Yggdrasil.Tiles.Furniture
{
	public class VikingChestTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			ChestDrop = ModContent.ItemType<Items.Placeable.Furniture.VikingChest>();
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.VikingChest>();
