...
{
	public class VikingSummon : YggdrasilProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Viking");
		...
		private bool CheckActive(Player owner)
		{
			...
			{
				owner.ClearBuff(ModContent.BuffType<VikingSummonBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<VikingSummonBuff>()))
			{
