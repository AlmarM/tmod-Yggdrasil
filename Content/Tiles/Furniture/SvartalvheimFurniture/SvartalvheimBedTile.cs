...
public class SvartalvheimBedTile : YggdrasilTile
{
	public override void SetStaticDefaults()
	{
		...
		name.SetDefault("Svartalvheim Bed");
	...
	{
		Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 64, 32, ModContent.ItemType<SvartalvheimBed>());
	}
	...
	public override void MouseOver(int i, int j)
	{
		...
		else
		{
			player.noThrow = 2;
			player.cursorItemIconEnabled = true;
			player.cursorItemIconID = ModContent.ItemType<SvartalvheimBed>();
		}
	}
