...
public class SvartalvheimChairTile : YggdrasilTile
{
	public const int NextStyleHeight = 36; // Calculated by adding all CoordinateHeights + CoordinatePaddingFix.Y applied to all of them + 2
	public override void SetStaticDefaults()
	{
		...
		name.SetDefault("Svartalvheim Chair");
	...
	{
		Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 32, 16, ModContent.ItemType<SvartalvheimChair>());
	}
	...
	public override void MouseOver(int i, int j)
	{
		...
		player.cursorItemIconID = ModContent.ItemType<SvartalvheimChair>();
