...
public class NordicWoodChairTile : YggdrasilTile
{
	...
	public override void SetStaticDefaults()
	{
		...
		name.SetDefault("Nordic Wood Chair");
	...
	{
		Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 32, 16, ModContent.ItemType<NordicWoodChair>());
	}
