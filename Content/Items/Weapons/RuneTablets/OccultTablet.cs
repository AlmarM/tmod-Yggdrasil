...
{
    public class OccultTablet : RunicItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<OccultTabletProjectile>();
            Item.shootSpeed = 10f;
        ...
        protected virtual void OnRightClick(Player player)
        {
            ...
            {
                int HealingValue = (runemasterPlayer.InsanityValue * 2);
