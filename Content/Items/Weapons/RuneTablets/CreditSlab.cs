...
{
    public class CreditSlab : RunicItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<CreditSlabProjectile>();
            Item.shootSpeed = 10f;
        ...
        protected virtual void OnRightClick(Player player)
        {
            ...
            const int ExplosionProjectiles = 15;
            var Type2 = ModContent.ProjectileType<CreditSlabProjectileExplosion>();
