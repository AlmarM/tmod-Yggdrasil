    ...
    public class VolvaTown : YggdrasilNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
            {
                ...
                new FlavorTextBestiaryInfoElement(
                    "It is told that V�lva have the ability to foretell future events and perform sorcery"),
            });
        }
        ...
        public override bool CanTownNPCSpawn(int numTownNPCs, int money)
        {
            ...
            return Main.player.Any(
                x => x.active && x.inventory.Any(y => y.type == ModContent.ItemType<VikingDistaff>()));
        }
